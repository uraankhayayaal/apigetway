...
final class OpenApiGeneratorService
{
    ...
    private const OPENAPI_FILE = './openapi.json';

    private const OPENAPI_FORMAT = 'json';
    ...
    public function __construct()
    {
        ...
        $this->analysis->openapi->info = new OA\Info(title: 'API GETWAY', version: '0.0.1');
    }
    ...
    public function includeServicesDods(): self
    {
        (new OpenApiMergeService())->buildServicesDoc($this->analysis);
    ...
    {
        $this->analysis->openapi->saveAs(self::OPENAPI_FILE, self::OPENAPI_FORMAT);
    }
